...
def get_options(warn=False):
    ...
    parser.add_option("-t", "--transition", default=60, help="transition (in seconds) default=8")
    parser.add_option("-i", "--inter", default=.1, help="section that's not transitioning (in seconds) default=8")
